...
motive_streamer__msg__MotiveRigidBody__init(motive_streamer__msg__MotiveRigidBody * msg)
{
  ...
  if (!geometry_msgs__msg__Pose__init(&msg->pose)) {
    motive_streamer__msg__MotiveRigidBody__fini(msg);
    return false;
  }
  return true;
}
...
motive_streamer__msg__MotiveRigidBody__create()
{
  ...
  motive_streamer__msg__MotiveRigidBody * msg = (motive_streamer__msg__MotiveRigidBody *)allocator.allocate(sizeof(motive_streamer__msg__MotiveRigidBody), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(motive_streamer__msg__MotiveRigidBody));
  bool success = motive_streamer__msg__MotiveRigidBody__init(msg);
  if (!success) {
...
motive_streamer__msg__MotiveRigidBody__Sequence__init(motive_streamer__msg__MotiveRigidBody__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  motive_streamer__msg__MotiveRigidBody * data = NULL;

  if (size) {
    data = (motive_streamer__msg__MotiveRigidBody *)allocator.zero_allocate(size, sizeof(motive_streamer__msg__MotiveRigidBody), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = motive_streamer__msg__MotiveRigidBody__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        motive_streamer__msg__MotiveRigidBody__fini(&data[i - 1]);
      }
...
motive_streamer__msg__MotiveRigidBody__Sequence__fini(motive_streamer__msg__MotiveRigidBody__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      motive_streamer__msg__MotiveRigidBody__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  motive_streamer__msg__MotiveRigidBody__Sequence * array = (motive_streamer__msg__MotiveRigidBody__Sequence *)allocator.allocate(sizeof(motive_streamer__msg__MotiveRigidBody__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = motive_streamer__msg__MotiveRigidBody__Sequence__init(array, size);
  if (!success) {
...
motive_streamer__msg__MotiveRigidBody__Sequence__destroy(motive_streamer__msg__MotiveRigidBody__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    motive_streamer__msg__MotiveRigidBody__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
motive_streamer__msg__MotiveRigidBody__Sequence__are_equal(const motive_streamer__msg__MotiveRigidBody__Sequence * lhs, const motive_streamer__msg__MotiveRigidBody__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!motive_streamer__msg__MotiveRigidBody__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  motive_streamer__msg__MotiveRigidBody__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(motive_streamer__msg__MotiveRigidBody);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    motive_streamer__msg__MotiveRigidBody * data =
      (motive_streamer__msg__MotiveRigidBody *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!motive_streamer__msg__MotiveRigidBody__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          motive_streamer__msg__MotiveRigidBody__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!motive_streamer__msg__MotiveRigidBody__copy(
