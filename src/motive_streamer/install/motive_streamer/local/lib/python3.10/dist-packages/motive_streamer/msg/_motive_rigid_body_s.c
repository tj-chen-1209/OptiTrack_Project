...
bool motive_streamer__msg__motive_rigid_body__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("motive_streamer.msg._motive_rigid_body.MotiveRigidBody", full_classname_dest, 54) == 0);
  }
  motive_streamer__msg__MotiveRigidBody * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of MotiveRigidBody */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("motive_streamer.msg._motive_rigid_body");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MotiveRigidBody");
